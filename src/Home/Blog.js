...
const common = [
  {
    ...
    date: "24 March 2023",
    title4:
      "Lorem ipsum dolor sit amet elit. Sed efficitur quis purus utinterdum. Aliquam dolor eget urna ultricies tincidunt libero sit amet",
    title5: "5324 Share",
    icon5: faComment,
    icon6: faShare,
    title6: "5 comments",
      ...
      <div className="container">
        ...
        <div className="row g-5 justify-content-center">
          {common.map((value, index) => (
            <div className="col-lg-3 col-xl-4 wow fadeIn" data-wow-delay=".3s">
              <div className="blog-item position-relative  bg-light rounded">
                <img
                  src={value.imgsrc}
                  className="img-fluid h-50 rounded-top"
                  alt=""
                />
                <span
                ...
                >
                  <div className="blog-icon btn btn-success ms-0 rounded-pill my-auto w-50">
                    <a href="" className="btn text-white bg-success">
                      {value.btn}
                    </a>
                  </div>
                  <div className="blog-btn-icon btn btn-success px-4 py-3 rounded-pill ">
                    <div className="blog-icon-1 ">
                      <p className="text-white px-2 bg-success">
                        {value.title2}
                        <i className=" ms-3">
