  ...
  return (
    ...
    <div className="container">
        <div className="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" >
            ...
            <p className="mb-2 text-secondary">The contact form is currently inactive. Get a functional and working contact <br />form with Ajax & PHP in a few minutes. Just copy and paste the files, add a <br /> little code and you're done. <a href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
        </div>
        <div className="contact-detail position-relative p-5">
            <div className="row g-5 mb-5 justify-content-center">
                <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".3s">
                    <div className="d-flex bg-light p-3 rounded">
                        <div className="flex-shrink-0 btn-square bg-success w-25 rounded-circle" >
                        <FontAwesomeIcon icon={faMapMarkerAlt} className="text-white mt-4 ms-4" />                        </div>
                        <div className="ms-3">
                ...
                <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".5s">
                    <div className="d-flex bg-light p-3 rounded">
                        <div className="flex-shrink-0 btn-square bg-success w-25 rounded-circle" >
                        <i> <FontAwesomeIcon icon={faPhoneAlt} className="text-white mt-4 ms-4" />   </i>
                        </div>
                        <div className="ms-3">
                ...
                <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                    <div className="d-flex bg-light p-3 rounded ">
                        <div className="flex-shrink-0 btn-square bg-success w-25 rounded-circle" >
                            <i> <FontAwesomeIcon icon={faEnvelope} className="text-white mt-4 ms-4" /> </i>
                        </div>
                        <div className="ms-3">
            ...
            <div className="row g-5">
                <div className="col-lg-6 wow fadeIn" data-wow-delay=".3s">
                    <div className="p-5 h-100 rounded contact-map bg-success">
                        <iframe className="rounded w-100 h-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3025.4710403339755!2d-73.82241512404069!3d40.685622471397615!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c26749046ee14f%3A0xea672968476d962c!2s123rd%20St%2C%20Queens%2C%20NY%2C%20USA!5e0!3m2!1sen!2sbd!4v1686493221834!5m2!1sen!2sbd"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
                <div className="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                    <div className="p-5 rounded contact-form bg-success">
                        <div className="mb-4">
