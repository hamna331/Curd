          ...
          <div className="container">
              <div className="row g-4">
                  <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                      <div className="service-item text-center pt-3 bg-light">
                          <div className="p-4">
                  ...
                  <div className="col-lg-3 col-sm-6 wow fadeInUp bg-light" data-wow-delay="0.3s">
                  ...
                  <div className="col-lg-3 col-sm-6 wow fadeInUp bg-light" data-wow-delay="0.5s">
                      <div className="service-item text-center pt-3">
                          <div className="p-4">
                  ...
                  <div className="col-lg-3 col-sm-6 wow fadeInUp bg-light" data-wow-delay="0.7s">
                      <div className="service-item text-center pt-3">
                          <div className="p-4">
